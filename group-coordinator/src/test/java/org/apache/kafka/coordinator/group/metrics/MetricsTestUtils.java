...
public class MetricsTestUtils {
    ...
    static void assertGaugeValue(Metrics metrics, String metricName, long count) {
        Long metricVal = (Long) metrics.metrics().get(metrics.metricName(metricName, METRICS_GROUP)).metricValue();
